...
serve(async (req) => {
  ...
  try {
    ...
    if (action === 'submit_demo') {
      ...
      const webhookUrl = 'https://n8n.srv1100597.hstgr.cloud/webhook/cb4880ae-fa97-4524-afff-87105ea9bb44';
      ...
      console.log('Demo2 submission received:', { business_type: data.business_type, timeline: data.timeline, rateLimitRemaining: remaining });
