...
// Rate limiting: 3 requests per minute per IP (stricter for webhook protection)
const rateLimitStore = new Map<string, { count: number; resetTime: number }>();
const RATE_LIMIT_WINDOW_MS = 60 * 1000;
const MAX_REQUESTS_PER_WINDOW = 3;

// Global burst protection: max 20 total requests per minute across all IPs
