      ...
      steps: [
        {
          number: '01',
          title: 'שלב 1: בנייה',
          description: 'אנחנו בונים את הסוכן שלכם בסביבה מבודדת - כך תראו איך הוא עובד לפני שהוא יוצא לאוויר',
        },
        {
          number: '02',
          title: 'שלב 2: שילוב',
          description: 'אנחנו מחברים את הסוכן למערכות שלכם, מריצים בדיקות, ומלווים אתכם בהטמעה המלאה',
        },
        {
          number: '03',
          title: 'שלב 3: כיוון',
          description: 'אנחנו משפרים את הסוכן ותומכים בכם לאורך זמן ככל שהצרכים מתפתחים',
        },
      ],
    },
    // Contact
