...
export const translations = {
  en: {
    ...
    metrics: {
      ...
      subtitle: 'Three numbers that change how your clinic books patients.',
      stats: [
        {
          number: '60',
          prefix: '<',
          ...
          description: 'Every lead answered, day or night.',
        },
        {
          number: '24',
          suffix: '/7',
          label: 'Always on',
          description: 'The follow-up never clocks out.',
        },
        {
          number: '72',
          suffix: 'h',
          label: 'From signup to live',
          description: 'From signup to live, not three months.',
        },
      ],
    },
    // Testimonials
