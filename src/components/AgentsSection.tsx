...
import { Bot, MessageSquare, PhoneOutgoing, Check, ArrowRight } from 'lucide-react';
...
const AgentsSection = () => {
  ...
  // Only sofia and david - marcus/Or is now the inline OrAgentCard
  const agents = [
    {
      key: 'sofia',
      icon: MessageSquare,
  ...
  return (
    <>
            ...
            {(() => {
              ...
              return (
                ...
                >
                  ...
                  <Button variant={styles.buttonVariant} className="w-full group" onClick={agent.onClick}>
      ...
      {/* Voice Agent Dialog - for David only */}
      <VoiceAgentDialog 
        open={dialogOpen} 
