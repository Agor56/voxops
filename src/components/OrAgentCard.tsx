...
import { Phone, Check, ArrowRight, Mic, MicOff, PhoneOff, Loader2 } from 'lucide-react';
...
import { SYSTEM_INSTRUCTION, TOOLS, MOCK_SLOTS } from './live-agent/constants';
...
const OrAgentCard = ({ className = '' }: OrAgentCardProps) => {
  ...
  const isSpeaking = isConnected && isPlayingRef.current;
  ...
  const agentData = t.agents.marcus;
