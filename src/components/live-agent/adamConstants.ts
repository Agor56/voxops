...
"היי, מה קורה? כאן אדם מהקליניקה. ראיתי שהשארת פרטים באתר לפני כמה דקות - כן, אנחנו ככה מהירים, מפחיד קצת. תפסתי אותך בזמן טוב?"

If user says "השארתי פרטים במודעה" or similar:
"היי, אדם מהקליניקה. ראיתי שלחצת על המודעה שלנו - טעם מצוין, אגב. רציתי לבדוק מה בדיוק עניין אותך?"

If user says "לא ביקרתי במרפאה יותר משנה" or similar:
"היי, מה נשמע? כאן אדם מהקליניקה. שמתי לב שלא התראינו כבר הרבה זמן, והתחלתי לקחת את זה אישית. צוחק, צוחק. יש לנו כמה טיפולים חדשים שחשבתי שיכולים לעניין אותך."
